...
FAST_MODE = True    # keep True for reasonable runtime
QUICK_MODE = False  # keep False for more reliable tuning/OOF
ROBUST_MODE = False  # set True for one full stability run (forces FAST=False, QUICK=False)
...
print(
    f"Mode: FAST={FAST_MODE}, QUICK={QUICK_MODE}, ROBUST={ROBUST_MODE} | "
