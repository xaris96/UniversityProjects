...
public class DB {
    ...
    /* Database connection settings are read from environment variables for public portfolio safety. */
	private final String dbServer = System.getenv().getOrDefault("DB_HOST", "YOUR_DB_HOST");
	private final String dbServerPort = System.getenv().getOrDefault("DB_PORT", "3306");
	private final String dbName = System.getenv().getOrDefault("DB_NAME", "YOUR_DB_NAME");
	private final String dbusername = System.getenv().getOrDefault("DB_USER", "YOUR_DB_USER");
	private final String dbpassword = System.getenv().getOrDefault("DB_PASSWORD", "YOUR_DB_PASSWORD");
