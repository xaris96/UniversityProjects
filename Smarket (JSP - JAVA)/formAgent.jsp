...
<header>
    ...
    <h1>Εγγραφή Εκπροσώπου </h1>
</header>

<main>
    <form id="registerAgent" action="registerController.jsp" method="POST">
        <input type="hidden" id="userType" name="userType" value="Agent">

        <h2>Στοιχεία Εγγραφής Εκπροσώπου </h2>
        ...
        <label for="tax_code">ΑΦΜ:</label>
        <input type="text" id="tax_code" name="tax_code" required>

        <!--<label for="certification">Πιστοποιητικό Σύνδεσης με Επιχείρηση:</label>
        <input type="file" id="certification" name="certification" required> -->

        <label for="supermarket">Σούπερ Μάρκετ:</label>
        <input type="Supermarket" id="supermarket" name="supermarket" required>


            <label for="Stax_code">ΑΦΜ Επιχείρησης:</label>
            <input type="text" id="Stax_code" name="Stax_code" required>

            <label for="S_address">Διεύθυνση:</label>
            <input type="text" id="S_address" name="S_address" required>

            <label for="S_zip">Ταχυδρομικός Κώδικας:</label>
            <input type="text" id="S_zip" name="S_zip" required>
        ...
        <div class="button-container">
            <button type="button" class="button back-button" onclick="window.location.href='register.jsp'">Επιστροφή</button>
